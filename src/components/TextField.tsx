...
// Constant
const textFieldVariants = cva("box-content  relative", {
    variants: {
        variant: {
            outline: "",
        },
    ...
    ({ label, variant, sizeInput, className }, ref) => {
        ...
        return (
            <div className={cn(textFieldVariants({ variant, sizeInput, className }))}>
                <FormLabel
                    className={cn(
                        "absolute font-normal transition-transform duration-300 z-10",
                        isFocused
                            ? "translate-x-[7px] translate-y-[-10px] scale-75"
                            : "translate-x-[12px] translate-y-[16px] scale-100",
                    )}
                >
                    {label}
                </FormLabel>
                <div className="absolute inset-0">
                    ...
                    <fieldset
                        className={cn(
                            ...
                            isFocused ? "border-blue-500 border" : "border border-input",
                        )}
                    >
