...
export const ProductCardFeatured = ({isReverse = false}: {isReverse?: boolean}) => {
  return (
    <div className={cn('flex py-3 rounded-md mb-16', isReverse ? 'flex-row-reverse' : "")}>
        <div className='w-[400px] p-8'>
            ...
            <button className='w-full text-white text-md font-semibold px-5 py-2 mt-8 rounded-lg bg-[#FFB800]'>PROCEED TO ORDER</button>
        </div>
